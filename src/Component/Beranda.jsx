...
, IconBrandTwitter, IconBrandFacebook, IconBrandInstagram, IconBrandTiktok } from '@tabler/icons';
import "./Beranda.css";
...
const [searchTerm, setSearchTerm] = useState('');
  ...
  return (
    ...
    <div className="list-panti-asuhan-kita">
        ...
        {data.filter((datas)=> datas.nama_panti.toLowerCase().includes(searchTerm.toLowerCase())).map((datas, index)=>{
          return(
      ...
      <div className="contact-form-left">
        ...
        <div className="contact-form-kontak">
          ...
          <div className="form-kontak-sosialmedia">
            <h5>Sosial Media</h5>
            <div>
                <IconBrandTwitter size={16} color="#3AB7FE" />
                <IconBrandFacebook size={16} color="#3AB7FE"/>
                <IconBrandInstagram size={16} color="#3AB7FE"/>
                <IconBrandTiktok size={16} color="#3AB7FE"/>
            </div>
          </div>
        </div>
      </div>
